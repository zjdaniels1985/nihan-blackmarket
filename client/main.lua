...
-- Events
RegisterNetEvent("nihan-blackmarket:client:UpdateShop", function(shop, itemData, amount)
    TriggerServerEvent("nihan-blackmarket:server:UpdateShopItems", shop, itemData, amount)
end)

RegisterNetEvent("nihan-blackmarket:client:SetShopItems", function(shop, shopProducts)
    Config.Locations[shop]["products"] = shopProducts
end)

RegisterNetEvent("nihan-blackmarket:client:RestockShopItems", function(shop, amount)
...
local function openShop(shop, data)
    ...
    local ShopItems = {}
    ShopItems.items = {}
    QBCore.Functions.TriggerCallback("nihan-blackmarket:server:getLicenseStatus", function(hasLicense, hasLicenseItem)
        ...
        while listen do
            if IsControlJustPressed(0, 38) then -- E
                if inChips then
                    ...
                    TriggerServerEvent("nihan-blackmarket:server:sellChips")
                else
                    exports["qb-core"]:KeyPressed()
